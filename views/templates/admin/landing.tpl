...
<div class="ps">
    <div class="ps_content">
        ...
        <div class="lf_clm">
            <div class="subscribe">
                <form id="new-account" method="post" action="{$smarty.server.REQUEST_URI}">
                ...
                <form action="{$smarty.server.REQUEST_URI}" method="post">
                    ...
                    <p>{l s='Already have a Feedaty account?' mod='feedaty'}
                        <br>
                        {l s='Enter your Merchant Code and your Client Secret:' mod='feedaty'}<br>
                    ...
                    <input id="Text3" type="text" name="code"><br>
                     <div class="label">{l s='Client Secret:' mod='feedaty'}</div>
                    <input id="Text3" type="text" name="secret"><br>
